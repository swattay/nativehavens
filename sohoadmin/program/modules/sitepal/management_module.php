...
# Give account form box different bg color if already verified
if ( sitepal_verified() ) {
   $verified_bgcolor = " style=\"background-color: #dff6ea;\"";
} else {
   $verified_bgcolor = "";
}
?>
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
 <tr>
  <td valign="top">
   ...
   <!---account_form-->
   <div id="container-account_info"<? echo $verified_bgcolor; ?>>

<?php
if ( !sitepal_verified("", "", "", true) ) {
   # Fill-in your info!
   $savebtn_txt = lang("Save & Continue")." &gt;&gt;";
   $form_disabled = "";
   $savebtn_display = "inline";
   $editbtn_display = "none";
   $cancelbtn_display = "none";
   echo "<h1>Please fill-in your SitePal account information</h1>\n";
   echo "<p class=\"nomar_top\">You must have a SitePal account in order to use the SitePal features.\n";
   ...
   # Verified!
   $savebtn_txt = lang("Save/Verify Changes");
   ...
   if ( $_GET['edit_info'] != "" ) {
      ...
      $savebtn_display = "inline";
      $editbtn_display = "none";
      $cancelbtn_display = "inline";
   } else {
      # normal
      $form_disabled = " disabled";
      $savebtn_display = "none";
      $editbtn_display = "inline";
      $cancelbtn_display = "none";
   }
   echo "<h1>Your SitePal account info was verified successfully!</h1>\n";
   echo "<p class=\"nomar_top\">The SitePal feature is now fully enabled. You're all set up to drag-and-drop SitePal scenes onto your site pages.</p>\n";
