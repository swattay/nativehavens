...
<DIV ID="sitepal_dialog" class="prop_layer" style="overflow: auto !important;">
...
//   echo "    Tell your web host to install cURL.<br/>\n";
   ...
   # [cancel]
   echo "   <div nowrap=\"\" onClick=\"".$closedialog_onclick."\" style=\"margin-top: 5px;z-index: 99;border-style: none solid solid; border-color: rgb(0, 0, 0); border-width: 1px; margin: 0pt; padding: 0px 15px; background-image: url(../../includes/display_elements/graphics/btn-nav_main-off.jpg); display: block; height: 16px;width: 100px;\" onclick=\"savePage('page_editor.php');\" onmouseout=\"this.style.backgroundImage='url(../../includes/display_elements/graphics/btn-nav_main-off.jpg)';\" onmouseover=\"this.style.backgroundImage='url(../../includes/display_elements/graphics/btn-nav_main-on.jpg)';\" class=\"nav_main\">\n";
...
//      echo "    <b>Drop-down box empty?</b>\n";
      ...
      if ( mysql_num_rows($rez) < 1 ) {
         echo "     <p style=\"margin:0; text-align:left;\"><b>SitePal not setup yet!</b> You have to fill-in your SitePal account info to unlock SitePal features like being able to drag-and-drop scenes onto pages. \n";
         echo "     Go to Main Menu > SitePal for more info/options.</p>\n";
      } else {
         echo "   <div style=\"width: 95%;padding:5px;border: 1px solid #980000;background-color: #efefef;text-align:left;\">\n";
      ...
      //echo "   </div>\n";
      echo "   <div nowrap=\"\" onClick=\"".$closedialog_onclick."\" style=\"z-index: 99;border-style: none solid solid; border-color: #000; border-width: 1px; margin: 5px 0 0 0; padding: 0px 15px; background-image: url(../../includes/display_elements/graphics/btn-nav_main-off.jpg); display: block; height: 16px;width: 200px;\" onclick=\"savePage('page_editor.php');\" onmouseout=\"this.style.backgroundImage='url(../../includes/display_elements/graphics/btn-nav_main-off.jpg)';\" onmouseover=\"this.style.backgroundImage='url(http://".$_SESSION['this_ip']."/sohoadmin/program/includes/display_elements/graphics/btn-nav_main-on.jpg)';\" class=\"nav_main\">\n";
