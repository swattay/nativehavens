...
session_start();
exit; // added by cameron on 10-4-08
...
// Make sure user is using Windows Based IE browser
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

$browser_type = $HTTP_USER_AGENT;

if (!eregi("MSIE", $browser_type) || !eregi("Win", $browser_type)) {
            ...
            <TABLE WIDTH="625" BORDER="0" CELLSPACING="3" CELLPADDING="3" ALIGN="CENTER">
              <TR> 
                <TD ALIGN="LEFT" VALIGN="TOP" CLASS="txt"> 
                            ...
                            <tr align="center" valign="top"> 
                              <td> 
                                <table align="center" border="0" cellspacing="0" cellpadding="3" class=txt>
                                  <tr> 
                                    <td valign="top" align=left><Font color=black>Username:</font><br>
                                      ...
                                      <div align=right> 
                                        ...
                                        <input type=submit class=txt style='cursor: hand;' value="Login">
                                        <BR>
                                      </div>
                                    </td>
                                  </tr>
                  ...
                  <center><font style='font-family: Arial; font-size: 8pt; color: black;'><a href="system_requirements.html">System Requirements</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="help.html">Login Help</a></font></center>
                </TD>
            </TABLE>
          </TD>
        </TR>
