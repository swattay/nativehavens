...
while ($row = mysql_fetch_array ($result)) {
  ...
  if($subpage_link[$a] == ""){
  	$hmainz .= "  <td class=\"".$HmainClass."\"><a href=\"".$pagelink_href."\" class=\"".$HmainClass."\">".$thispage."</a></td>\n";
  	$main_textmenu .= "<a href=\"".$pagelink_href."\">$thispage</a> | ";
  }else{
	if( eregi("http://", $subpage_link[$a]) || eregi("https://", $subpage_link[$a]) || eregi("mailto", $subpage_link[$a]) ){
	  	$hmainz .= "  <td class=\"".$HmainClass."\"><a href=\"".$subpage_link[$a]."\" class=\"".$HmainClass."\">".$thispage."</a></td>\n";
	  	$main_textmenu .= "<a href=\"".$subpage_link[$a]."\">$thispage</a> | ";
	}else{
	  	$hmainz .= "  <td class=\"".$HmainClass."\"><a href=\"http://".$subpage_link[$a]."\" class=\"".$HmainClass."\">".$thispage."</a></td>\n";
