		      ...
		      if ($tmp == $pageRequest || $tmp == $dup) {
				...
				if ($MENUTYPE == "buttons") {
      			...
      			if($subpage_link[$xedusvar] == ""){
      				...
      				//$sub_buttons .= "  <li><a href=\"index.php?pr=".$pagelink."\" title=\"".$thispage."\"><span>".$thispage."</span></a></li>\n";
      			}else{
      				$sub_buttons .= "       <a href=\"http://".$subpage_link[$xedusvar]."\" class=\"".$subClass."\">".$subpage_name[$xedusvar]."</a>\n";
      				//$sub_buttons .= "  <li><a href=\"http://".$subpage_link[$a]."\" title=\"".$thispage."\"><span>".$thispage."</span></a></li>\n";
      			}
      			$sub_buttons .= "      </div>\n";
      			$sub_buttons .= "     </td>\n";
				...
				if($subpage_link[$xedusvar] == ""){
					...
					$hsubz .= "  <li><a href=\"index.php?pr=".$tmp."\" title=\"".$subpage_name[$xedusvar]."\"><span>".$subpage_name[$xedusvar]."</span></a></li>\n";
				}else{
					//$hsubz .= "  <td class=\"hsubs\"><a href=\"http://".$subpage_link[$xedusvar]."\" class=\"hsubs\">".$subpage_name[$xedusvar]."</a></td>\n";
					$hsubz .= "  <li><a href=\"http://".$subpage_link[$xedusvar]."\" title=\"".$subpage_name[$xedusvar]."\"><span>".$subpage_name[$xedusvar]."</span></a></li>\n";
				}
				// ----------------------------------------------------------------------------------------
...
while ($row = mysql_fetch_array ($result)) {
  ...
  if($subpage_link[$a] == ""){
  	...
  	$hmainz .= "  <li><a href=\"index.php?pr=".$pagelink."\" title=\"".$thispage."\"><span>".$thispage."</span></a></li>\n";
  	$main_textmenu .= "<a href=\"index.php?pr=$pagelink\">$thispage</a> | ";
  }else{
  	//$hmainz .= "  <td class=\"hmains\"><a href=\"http://".$subpage_link[$a]."\" class=\"hmains\">".$thispage."</a></td>\n";
  	$hmainz .= "  <li><a href=\"http://".$subpage_link[$a]."\" title=\"".$thispage."\"><span>".$thispage."</span></a></li>\n";
