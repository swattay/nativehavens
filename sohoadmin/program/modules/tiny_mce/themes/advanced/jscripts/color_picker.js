...
function generateWebColors() {
	...
	for (i=0; i<colors.length; i++) {
		h += '<td bgcolor="' + colors[i] + '">'
			+ '<a href="javascript:selectColor();" onfocus="showColor(\'' + colors[i] +  '\');">'
...
function generateNamedColors() {
	...
	for (n in named) {
		v = named[n];
		h += '<a href="javascript:selectColor();" onfocus="showColor(\'' + n +  '\');" onmouseover="document.getElementById(\'colorname\').innerHTML = \'' + v +  '\'";" style="background-color: ' + n + '"><!-- IE --></a>'
	}
