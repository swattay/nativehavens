...
function preinit() {
	...
	var url = tinyMCE.getParam("external_link_list_media");
	if (url != null) {
		// Fix relative
...
function init() {
	...
	document.getElementById('linklistmediacontainer').innerHTML = getMediaListHTML('linklistmedia','href');
	...
	if (action == "update") {
		...
		selectByValue(formObj, 'linklistmedia', href);
...
function getAnchorListHTML(id, target) {
	...
	html += '<option value="">select anchor...</option>';

	for (var i=0; i<nodes.length; i++) {
	   myName = tinyMCE.getAttrib(nodes[i], "name")
		if (myName != "")
			html += '<option style=\"font-weight:bold; background: #DBFFCF none repeat scroll 0%; color: black; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial;\" value="#' + myName + '">' + myName + '</option>';
	}
...
function getLinkListHTML(elm_id, target_form_element, onchange_func) {
	...
	for (var i=0; i<tinyMCELinkList.length; i++)
		html += '<option style=\"background: #CFE9FF none repeat scroll 0%; color: black; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; font-weight:bold;\" value="' + tinyMCELinkList[i][1] + '">' + tinyMCELinkList[i][0] + '</option>';
...
function getMediaListHTML(elm_id, target_form_element, onchange_func) {
	...
	for (var i=0; i<tinyMCEMediaList.length; i++){
		stylecolor = 'yellow';
		stylecolor2 = 'black';
	if(tinyMCEMediaList[i][0].search(/\.zip$/i) != -1){
		stylecolor = 'pink';
		stylecolor2 = 'black';
	}
	if(tinyMCEMediaList[i][0].search(/\.tgz$/i) != -1){
		stylecolor = 'pink';
		stylecolor2 = 'black';
	}
	if(tinyMCEMediaList[i][0].search(/\.csv$/i) != -1){
		stylecolor = 'green';
		stylecolor2 = 'white';
	}
	if(tinyMCEMediaList[i][0].search(/\.avi$/i) != -1){
		stylecolor2 = 'white';
		stylecolor = 'red';
	}
	if(tinyMCEMediaList[i][0].search(/\.mpg$/i) != -1){
		stylecolor2 = 'white';
		stylecolor = 'red';
	}
	if(tinyMCEMediaList[i][0].search(/\.mpeg$/i) != -1){
		stylecolor2 = 'white';
		stylecolor = 'red';
	}
	if(tinyMCEMediaList[i][0].search(/\.wmv$/i) != -1){
		stylecolor2 = 'white';
		stylecolor = 'red';
	}
	if(tinyMCEMediaList[i][0].search(/\.wma$/i) != -1){
		stylecolor2 = 'white';
		stylecolor = 'red';
	}
	if(tinyMCEMediaList[i][0].search(/\.ppt$/i) != -1){
		stylecolor2 = 'white';
		stylecolor = '#0DFF00';
	}
	
	if(tinyMCEMediaList[i][0].search(/\.pdf$/i) != -1){
		stylecolor2 = 'black';
		stylecolor = '#CFE9FF';
	}
	if(tinyMCEMediaList[i][0].search(/\.html$/i) != -1){
		stylecolor2 = 'white';
		stylecolor = 'orange';
	}
	if(tinyMCEMediaList[i][0].search(/\.htm$/i) != -1){
		stylecolor2 = 'white';
		stylecolor = 'orange';
	}
	if(tinyMCEMediaList[i][0].search(/\.doc$/i) != -1){
		stylecolor2 = 'white';
		stylecolor = 'navy';
	}
	if(tinyMCEMediaList[i][0].search(/\.txt$/i) != -1){
		stylecolor2 = 'white';
		stylecolor = 'blue';
	}
	
		html += '<option style=\"background: '+stylecolor+' none repeat scroll 0%; color:'+stylecolor2+'; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; font-weight:bold;\" value="' + tinyMCEMediaList[i][1] + '">' + tinyMCEMediaList[i][0] + '</option>';
	}
	html += '</select>';
