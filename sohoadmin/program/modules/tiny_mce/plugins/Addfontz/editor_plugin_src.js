...
tinyMCE.importPluginLanguagePack('add_fontz');
...
var TinyMCE_EmotionsPlugin = {
	...
	getControlHTML : function(cn) {
		switch (cn) {
			case "add_fontz":
				return tinyMCE.getButtonHTML(cn, 'lang_emotions_desc', '{$pluginurl}/images/emotions.gif', 'mceAddFontz');
		}
	...
	/**
	 * Executes the mceAddFontz command.
	 */
...
// Register plugin
tinyMCE.addPlugin('add_fontz', TinyMCE_EmotionsPlugin);
