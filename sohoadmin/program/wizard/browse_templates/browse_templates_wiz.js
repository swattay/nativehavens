...
function view_template_details(addon_id) {
   ...
   ajaxDoBrowse('../modules/site_templates/browse_templates/template_details.ajax.php?addonid='+addon_id, 'template_details');
...
function loadTemplates(sort_type){
   ...
   ajaxDoBrowse('../modules/site_templates/browse_templates/template_results.ajax.php?category='+showCats+'&next_start='+next_start+'&color='+showColor+'&sortby='+sortBy+'&limit_num='+limit_num, 'template_results');
}
