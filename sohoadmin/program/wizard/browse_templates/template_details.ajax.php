   ...
   <div id="layouts">
      ...
      <?
         ...
         if(count($getTemplate['template_features']) == 0){
            echo "         <li>".lang("Oops, this template does not seem to be in the correct format.<br/>Please select a different template.")."</li>\n";
         }
      ?>
      </ul>
  </div> 
...
?>
 <div id="buttons">
  <input type="button" value="<?php echo lang('Preview Template'); ?> &gt;&gt;" onclick="popup_window('http://<?php echo $_SESSION['docroot_url']; ?>/index.php?rmtemplate=<?php echo $getTemplate['folder_name']; ?>', '', '800px', '600px', '');"  class="btn_save" onMouseover="this.className='btn_saveon';" onMouseout="this.className='btn_save';" style="width: 200px;">
  <input type="button" value="<?php echo lang('Select Template'); ?> &gt;&gt;" onclick="document.location.href='start.php?WIZSTEP=step2&template_folder=<?php echo $getTemplate['folder_name']; ?>&TEMPLATE=<?php echo $getTemplate['folder_name']; ?>&todo=install_template';"  class="btn_save" onMouseover="this.className='btn_saveon';" onMouseout="this.className='btn_save';" style="width: 200px;">
