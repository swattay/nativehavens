...
if ( isset($_POST['upgrade']) ) {
   ...
   if ( $noMods == "" ) { // Good to go!
      ...
      echo "<div style=\"text-align: center; width: 100%; border: 1px solid #6699cc; padding: 15px;\">\n";
      echo " Thank you for submitting your upgrade request.\n";
      echo "</div>\n";
      exit;
...
<table width="550"  border="0" align="center" cellpadding="5" cellspacing="0" class="feature_group">
 ...
 <tr>
  ...
  <td width="406">
   <span class="gray">http://</span>    
   <input name="upgrade[domain]" value="<? echo $_SERVER['HTTP_HOST']; ?>" type="text" class="tfield orange" style="width: 200px;">
  </td>
 </tr>
 <tr>
  <td>
 ...
 <tr>
  <td colspan="2" style="padding-left: 25px; padding-top: 0px;">
   <table width="100%" border="0" cellpadding="2" cellspacing="0" class="text">
    <tr>
     <td>
      <input name="upgrade_mods[]" type="checkbox" id="event_calendar" value="Event Calendar">
     </td>
     <td>
...
$modz = array('calendar', 'cart', 'enewsletter', 'blog', 'secure', 'backup', 'dbMan');
