...
<DIV ID="premiumlayer" style="position:absolute; left:0px; top:0px; width:100%; height:115; z-index:4; overflow: none; background-color: oldlace; visibility: hidden" onMouseOver="HighDropZone();">
    ...
    <td>
		<SELECT id="albumname" NAME="albumname" style='font-face: Arial; font-size: 8pt; width: 250px;' onChange="if (this.value!=-1) {document.getElementById('thumb_row').style.display=''} else {document.getElementById('thumb_row').style.display='none'}">
    ...
    <?php
      ...
      $rows = 5;
	    ...
	    $THIS_DISPLAY .= '   <td class="ctable" valign="middle">
                              <input type="radio" name="my_layout" value="1" checked> &nbsp <img src="images/left-right.gif" alt="left-right layout" width="50" height="50" align="middle">
                              <input type="radio" name="my_layout" value="2"> &nbsp <img src="images/top-bottom.gif" alt="top-bottom layout" width="50" height="50" align="middle">
                              <input type="radio" name="my_layout" value="3"> &nbsp <img src="images/top.gif" alt="top layout" width="50" height="50" align="middle">
                              <input type="radio" name="my_layout" value="4"> &nbsp <img src="images/image_only.gif" alt="top layout" width="50" height="50" align="middle">
                              <input type="radio" name="my_layout" value="5"> &nbsp <img src="images/bottom-all.gif" alt="bottom all layout" width="50" height="50" align="middle">
                              <input type="radio" name="my_layout" value="6"> &nbsp <img src="images/bottom.gif" alt="bottom layout" width="50" height="50" align="middle">
                           </td></tr>';
	    ...
	    $THIS_DISPLAY .= '   &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" style="width: 30px" class="text" value="'.$rows.'" name="rows" id="rows">&nbsp;&nbsp;
            	 <span style="display: none" id="thumb_row"><input type="checkbox" id="show_thumb" name="show_thumb" value="on">'.lang('Show album thumbnail before album').'</span>
      </td></tr>';
      echo $THIS_DISPLAY;
		?>
		</table>
