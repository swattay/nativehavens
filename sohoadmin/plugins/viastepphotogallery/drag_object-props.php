...
<DIV ID="premiumlayer" style="position:absolute; left:0px; top:0px; width:100%; z-index:150; overflow: none; background-color: oldlace; visibility: hidden" onMouseOver="HighDropZone();">
	<form id="temp_id">
...
/*	    $THIS_DISPLAY .= '   <td class="ctable" valign="middle">
                              <input type="radio" name="my_layout" value="1" checked="true"> &nbsp <img src="../../../plugins/viastepphotogallery/page_editor/images/left-right.gif" alt="left-right layout" width="50" height="50" align="middle">
                              ...
                              <input type="radio" name="my_layout" value="7"> &nbsp <img src="../../../plugins/viastepphotogallery/page_editor/images/top-bottom-html.gif" alt="top-bottom-html" width="50" height="50" align="middle">
                              <input type="radio" name="my_layout" value="8"> &nbsp <img src="../../../plugins/viastepphotogallery/page_editor/images/bottom-html.gif" alt="bottom-html" width="50" height="50" align="middle">
                           </td></tr>';
*/
	    $THIS_DISPLAY .= '   <td class="ctable" valign="middle">
                              <input type="radio" name="my_layout" value="1" checked="true">&nbsp<img src="../../../plugins/viastepphotogallery/page_editor/images/left-right.gif" alt="left-right layout" width="40" height="40" align="middle">
                              <input type="radio" name="my_layout" value="2">&nbsp<img src="../../../plugins/viastepphotogallery/page_editor/images/top-bottom.gif" alt="top-bottom layout" width="40" height="40" align="middle">
                              <input type="radio" name="my_layout" value="3">&nbsp<img src="../../../plugins/viastepphotogallery/page_editor/images/top.gif" alt="top layout" width="40" height="40" align="middle">
                              <input type="radio" name="my_layout" value="4">&nbsp<img src="../../../plugins/viastepphotogallery/page_editor/images/image_only.gif" alt="image only layout" width="40" height="40" align="middle">
                              <input type="radio" name="my_layout" value="5">&nbsp<img src="../../../plugins/viastepphotogallery/page_editor/images/bottom-all.gif" alt="bottom all layout" width="40" height="40" align="middle">
                              <input type="radio" name="my_layout" value="6">&nbsp<img src="../../../plugins/viastepphotogallery/page_editor/images/bottom.gif" alt="bottom layout" width="40" height="40" align="middle">
                              <input type="radio" name="my_layout" value="7">&nbsp<img src="../../../plugins/viastepphotogallery/page_editor/images/top-bottom-html.gif" alt="top-bottom-html" width="40" height="40" align="middle">
                              <input type="radio" name="my_layout" value="8">&nbsp<img src="../../../plugins/viastepphotogallery/page_editor/images/bottom-html.gif" alt="bottom-html" width="40" height="40" align="middle">
                           </td></tr>';
	    ...
	    $THIS_DISPLAY .= '   &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" style="width: 30px" class="text" value="'.$rows.'" name="rows" id="rows_id">&nbsp;&nbsp;
            	 <span style="display: none" id="thumb_row"><input type="checkbox" name="show_thumb" value="on" id="show_thumb_id">'.lang('Show album thumbnail before album').'</span>
      </td></tr>';
      echo $THIS_DISPLAY;
		?>
		</table>
